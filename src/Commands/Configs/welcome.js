export default {
  ...
  async exec({ client, message, args, t }) {
    ...
    if (!message.member.permissions.has('ManageGuild') && !client.owners.includes(message.author.id)) return message.reply({
      content: `**${client.emotes.errado} › ${t('commands:welcome.errorPerm')}**`
    });
    ...
    const errorMessage = {
      embeds: [{
        title: `${client.emotes.config} • Siesta`,
