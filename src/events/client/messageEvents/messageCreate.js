...
module.exports = async (client, message) => {
  ...
  if(command.sameChannel && player && !message.member.voice.channel || message.member.voice.channel?.id !== message.guild.me.voice.channel?.id) return message.reply(`**${Emojis.errado} › ${lang.music.channelError}**`);
